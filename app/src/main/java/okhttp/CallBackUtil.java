...
public abstract class CallBackUtil<T> {
    ...
    /*在其他线程想刷新UI,只能在主线程下跑，要用Handler handler =new Handler(Looper.getMainLooper();
      如果在主线程刷新UI（或者只是实例化线程，这个会默认在当前线程），则只需Handler handler = new Handler();
     */
